...
def get_config():
    ...
    parser.add_argument("--episodes_num", type=int, default=60000, help="训练的回合数")

    parser.add_argument("--max-episode-len", type=int, default=240, help="每回合的步数")
    ...
    parser.add_argument("--save-dir", type=str, default=parent_path,
